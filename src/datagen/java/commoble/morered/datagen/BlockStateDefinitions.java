...
public abstract class BlockStateDefinitions
{
	...
	{
		public static final Codec<VariantBlockStateDefinition> CODEC = Codec.unboundedMap(Codec.STRING, PartDefinition.CODEC)
			.xmap(VariantBlockStateDefinition::new, VariantBlockStateDefinition::getVariants)
			.fieldOf("variants").codec();
		
		private final Map<String, PartDefinition> variants; public Map<String, PartDefinition> getVariants() { return this.variants; }
