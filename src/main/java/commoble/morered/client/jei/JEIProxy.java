...
public class JEIProxy implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        if (this.gatecraftingCategory == null) {
            throw new NullPointerException("More Red's Gatecrafting JEI category failed to register! Notify the More " +
                    "Red author for assistance https://github.com/Commoble/morered/issues");
        }
