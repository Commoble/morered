...
public class DirectionHelper {
     ...
     * -- let a relative secondary side index be an integer in the range [0,3], representing what the ordinal of a
     * direction would be
    ...
    Direction getDirectionToNeighborPos(BlockPos from, BlockPos to) {
