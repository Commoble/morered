...
public class BlockStateUtil {
    ...
    public static Direction getInputDirection(Direction attachmentDirection, int outputRotationIndex,
                                              int rotationsFromOutput) {
     ...
     * @param rotation       The y-axis-rotation type
    ...
    public static Direction getOutputDirectionFromRelativeHitVec(Vec3 hitVec,
                                                                 Direction directionTowardBlockAttachedTo) {
        ...
        Direction.Axis axis = directionTowardBlockAttachedTo.getAxis();
        float x = (float) (axis == Direction.Axis.X ? 0F : hitVec.x * 2 - 1);
        float y = (float) (axis == Direction.Axis.Y ? 0F : hitVec.y * 2 - 1);
        float z = (float) (axis == Direction.Axis.Z ? 0F : hitVec.z * 2 - 1);
