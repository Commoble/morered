...
public class PacketTypeFactory
{
	 ...
	 * @param defaultPacket If a packet instance cannot be parsed on the client, it will be treated as this packet instance instead.
	 * The defaultPacket instance must have the same class instance as any packets sent of this type,
