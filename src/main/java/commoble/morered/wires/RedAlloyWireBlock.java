...
{
	public static final VoxelShape[] NODE_SHAPES_DUNSWE = AbstractWireBlock.makeNodeShapes(1,2);
	public static final VoxelShape[] RAYTRACE_BACKBOARDS = AbstractWireBlock.makeRaytraceBackboards(2);
	public static final VoxelShape[] LINE_SHAPES = AbstractWireBlock.makeLineShapes(1,2);
