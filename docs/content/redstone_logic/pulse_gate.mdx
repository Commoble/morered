...
<table>
	...
	<tbody>
		<tr>
			...
			<td>
				![Shaped Crafting Recipe for Pulse Gates](https://commoble.net/images/morered/recipes/pulse_gate_recipe.png)
			</td>
		</tr>
		<tr>
			...
			<td>
				![Soldering Recipe for Pulse Gates](https://commoble.net/images/morered/recipes/pulse_gate_from_soldering.png)
			</td>
		</tr>
	</tbody>
</table>
...
![A preview of a Pulse Gate about to be placed against a wall with the output facing up](https://commoble.net/images/morered/pulse_gate_preview.png)
...
![Pulse Gate in its default state](https://commoble.net/images/morered/pulse_gate_example_0.png)

![Pulse Gate immediately after receiving power](https://commoble.net/images/morered/pulse_gate_example_1.png)

![Pulse Gate after the pulse concludes](https://commoble.net/images/morered/pulse_gate_example_2.png)
