	...
	<tbody>
		<tr>
			...
			<td style={{width: '30%'}}>
				...
				* 1x [<Asset width={32} height={32} location='redstone_torch'/> Redstone Torch](https://minecraft.wiki/Redstone_Torch)
			...
			<td>
				![Shaped Crafting Recipe for NOR Gates](https://commoble.s3.us-east-1.amazonaws.com/images/morered/recipes/nor_gate_recipe.png)
			</td>
		</tr>
		<tr>
			...
			<td>
				![Shaped Crafting Recipe for NOR Gates](https://commoble.s3.us-east-1.amazonaws.com/images/morered/recipes/nor_gate_from_gatecrafting.png)
			</td>
		</tr>
	</tbody>
</table>
...
The NOR Gate can be placed in 24 different orientations, on floors, walls, and ceilings.
...
![A preview of an NOR Gate about to be placed against a wall with the output facing up](https://commoble.s3.us-east-1.amazonaws.com/images/morered/nor_gate_preview.png)

The sprint key can be held while placing the block to change the axis of rotation.

While none of its three input sides are receiving redstone power, the NOR Gate emits maximum-strength redstone power from its output side. If any of its three input sides are receiving redstone power, the NOR Gate emits no power.

![NOR Gates in all eight input combinations](https://commoble.s3.us-east-1.amazonaws.com/images/morered/nor_gate_combinations.png)
