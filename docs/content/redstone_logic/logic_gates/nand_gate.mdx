...
<table>
	...
	<tbody>
		<tr>
			...
			<td>
				![Shaped Crafting Recipe for NAND Gates](https://commoble.s3.us-east-1.amazonaws.com/images/morered/recipes/nand_gate_recipe.png)
			</td>
		</tr>
		<tr>
			...
			<td>
				![Shaped Crafting Recipe for NAND Gates](https://commoble.s3.us-east-1.amazonaws.com/images/morered/recipes/nand_gate_from_gatecrafting.png)
			</td>
		</tr>
	</tbody>
</table>
...
![A preview of an NAND Gate about to be placed against a wall with the output facing up](https://commoble.s3.us-east-1.amazonaws.com/images/morered/nand_gate_preview.png)
...
![NAND Gates in all eight input combinations](https://commoble.s3.us-east-1.amazonaws.com/images/morered/nand_gate_combinations.png)
