...
<table>
	...
	<tbody>
		<tr>
			...
			<td>
				* 1x Two Input AND Gate
			</td>
			<td>
				![Shaped Crafting Recipe for Two Input AND Gates](https://commoble.s3.us-east-1.amazonaws.com/images/morered/recipes/two_input_and_gate_recipe.png)
			</td>
		</tr>
		<tr>
			...
			<td>
				![Shaped Crafting Recipe for Two Input AND Gates](https://commoble.s3.us-east-1.amazonaws.com/images/morered/recipes/two_input_and_gate_from_gatecrafting.png)
			</td>
		</tr>
	</tbody>
</table>
...
![A preview of an Two Input AND Gate about to be placed against a wall with the output facing up](https://commoble.s3.us-east-1.amazonaws.com/images/morered/two_input_and_gate_preview.png)
...
![Two Input AND Gates in all four input combinations](https://commoble.s3.us-east-1.amazonaws.com/images/morered/two_input_and_gate_combinations.png)
