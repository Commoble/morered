	...
	<tbody>
		<tr>
			...
			<td style={{width: '30%'}}>
				...
				* 3x [<Asset width={32} height={32} location='redstone_torch'/> Redstone Torch](https://minecraft.wiki/Redstone_Torch)
			...
			<td>
				![Shaped Crafting Recipe for XOR Gates](https://commoble.s3.us-east-1.amazonaws.com/images/morered/recipes/xor_gate_recipe.png)
			</td>
		</tr>
		<tr>
			...
			<td style={{width: '30%'}}>
				...
				* 4x [<Asset width={32} height={32} location='redstone'/> Redstone Dust](https://minecraft.wiki/Redstone_Dust)
			</td>
			<td>
				* 1x XOR Gate
			</td>
			<td>
				![Shaped Crafting Recipe for XOR Gates](https://commoble.s3.us-east-1.amazonaws.com/images/morered/recipes/xor_gate_from_gatecrafting.png)
			</td>
		</tr>
	</tbody>
</table>
...
![A preview of an XOR Gate about to be placed against a wall with the output facing up](https://commoble.s3.us-east-1.amazonaws.com/images/morered/xor_gate_preview.png)
...
![XOR Gates in all four input combinations](https://commoble.s3.us-east-1.amazonaws.com/images/morered/xor_gate_combinations.png)
