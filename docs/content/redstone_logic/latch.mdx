...
<table>
	...
	<tbody>
		<tr>
			...
			<td>
				![Shaped Crafting Recipe for Diodes](https://commoble.net/images/morered/recipes/latch_recipe.png)
			</td>
		</tr>
		<tr>
			...
			<td>
				![Soldering Recipe for Latch](https://commoble.net/images/morered/recipes/latch_from_gatecrafting.png)
			</td>
		</tr>
	</tbody>
</table>
...
![A preview of a Latch about to be placed against a wall with the output facing up](https://commoble.net/images/morered/latch_preview.png)
...
![State transformations of a Latch](https://commoble.net/images/morered/latch_combinations.png)
