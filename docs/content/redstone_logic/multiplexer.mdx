...
<table>
	...
	<tbody>
		<tr>
			...
			<td>
				![Shaped Crafting Recipe for Multiplexers](https://commoble.net/images/morered/recipes/multiplexer_recipe.png)
			</td>
		</tr>
		<tr>
			...
			<td>
				![Soldering Recipe for Multiplexers](https://commoble.net/images/morered/recipes/multiplexer_from_gatecrafting.png)
			</td>
		</tr>
	</tbody>
</table>
...
![A preview of an Multiplexer about to be placed against a wall with the output facing up](https://commoble.net/images/morered/multiplexer_preview.png)
...
![Multiplexers in all eight input combinations](https://commoble.net/images/morered/multiplexer_combinations.png)
