...
<table>
	...
	<tbody>
		<tr>
			...
			<td>
				![Shaped Crafting Recipe for XNOR Gates](https://commoble.net/images/morered/recipes/xnor_gate_recipe.png)
			</td>
		</tr>
		<tr>
			...
			<td>
				![Shaped Crafting Recipe for XNOR Gates](https://commoble.net/images/morered/recipes/xnor_gate_from_gatecrafting.png)
			</td>
		</tr>
	</tbody>
</table>
...
![A preview of an XNOR Gate about to be placed against a wall with the output facing up](https://commoble.net/images/morered/xnor_gate_preview.png)
...
![XNOR Gates in all four input combinations](https://commoble.net/images/morered/xnor_gate_combinations.png)
