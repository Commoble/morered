...
<table>
	...
	<tbody>
		<tr>
			...
			<td>
				![Shaped Crafting Recipe for Bitwise XNOR Gates](https://commoble.net/images/morered/recipes/bitwise_xnor_gate_from_gatecrafting.png)
			</td>
		</tr>
	</tbody>
</table>
...
![Bitwise XNOR Gate with input combinations](https://commoble.net/images/morered/bitwise_xnor_gate_combinations.png)
