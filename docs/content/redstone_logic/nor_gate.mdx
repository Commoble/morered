...
<table>
	...
	<tbody>
		<tr>
			...
			<td>
				![Shaped Crafting Recipe for NOR Gates](https://commoble.net/images/morered/recipes/nor_gate_recipe.png)
			</td>
		</tr>
		<tr>
			...
			<td>
				![Shaped Crafting Recipe for NOR Gates](https://commoble.net/images/morered/recipes/nor_gate_from_gatecrafting.png)
			</td>
		</tr>
	</tbody>
</table>
...
![A preview of an NOR Gate about to be placed against a wall with the output facing up](https://commoble.net/images/morered/nor_gate_preview.png)
...
![NOR Gates in all eight input combinations](https://commoble.net/images/morered/nor_gate_combinations.png)
