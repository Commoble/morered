...
<table>
	...
	<tbody>
		<tr>
			...
			<td>
				![Shaped Crafting Recipe for Diodes](https://commoble.net/images/morered/recipes/diode_recipe.png)
			</td>
		</tr>
		<tr>
			...
			<td>
				![Soldering Crafting Recipe for Diode](https://commoble.net/images/morered/recipes/diode_from_gatecrafting.png)
			</td>
		</tr>
	</tbody>
</table>
...
![A preview of a Diode about to be placed against a wall with the output facing up](https://commoble.net/images/morered/diode_preview.png)
...
![Diodes in both input combinations](https://commoble.net/images/morered/diode_combinations.png)
