	...
	<tbody>
		<tr>
			...
			<td style={{width: '250px'}}>
				* 8x [<ModAsset width={32} height={32} location='morered:stone_plate'/> Stone Plate](/en/mod/morered/docs/content/building_and_crafting/stone_plate)
			...
			<td>
				![Soldering Recipe for Hexidecrubrometers](https://commoble.net/images/morered/recipes/hexidecrubrometer_from_gatecrafting.png)
			</td>
		</tr>
	</tbody>
</table>
...
![Hexidecrubrometers being used to measure redstone power and chest fullness](https://commoble.net/images/morered/hexidecrubrometer_uses.png)
