	...
	<tbody>
		<tr>
			...
			<td style={{width: '250px'}}>
				* 8x [<Asset width={32} height={32} location='morered:stone_plate'/> Stone Plate](@morered:stone_plate)
				* 9x [<Asset width={32} height={32} location='redstone'/> Redstone Dust](https://minecraft.wiki/Redstone_Dust)
				* 4x [<Asset width={32} height={32} location='quartz'/> Nether Quartz](https://minecraft.wiki/Nether_Quartz)
			</td>
			<td>
