...
<table>
	...
	<tbody>
		<tr>
			...
			<td>
				![Shaped Crafting Recipe for OR Gates](https://commoble.net/images/morered/recipes/or_gate_recipe.png)
			</td>
		</tr>
		<tr>
			...
			<td>
				![Shaped Crafting Recipe for OR Gates](https://commoble.net/images/morered/recipes/or_gate_from_gatecrafting.png)
			</td>
		</tr>
	</tbody>
</table>
...
![A preview of an OR Gate about to be placed against a wall with the output facing up](https://commoble.net/images/morered/or_gate_preview.png)
...
![OR Gates in all eight input combinations](https://commoble.net/images/morered/or_gate_combinations.png)
