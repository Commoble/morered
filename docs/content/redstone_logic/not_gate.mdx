...
<table>
	...
	<tbody>
		<tr>
			...
			<td>
				![Shaped Crafting Recipe for NOT Gates](https://commoble.net/images/morered/recipes/not_gate_recipe.png)
			</td>
		</tr>
		<tr>
			...
			<td>
				![Soldering Crafting Recipe for NOT Gates](https://commoble.net/images/morered/recipes/not_gate_from_gatecrafting.png)
			</td>
		</tr>
	</tbody>
</table>
...
![A preview of a Not Gate about to be placed against a wall with the output facing up](https://commoble.net/images/morered/not_gate_preview.png)
...
![NOT Gates in both input combinations](https://commoble.net/images/morered/not_gate_combinations.png)
