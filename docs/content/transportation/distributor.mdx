...
<table>
	...
	<tbody>
		<tr>
			...
			<td style={{width: '30%'}}>
				* 4x [<ModAsset width={32} height={32} location='morered:shunt'/> Shunt](/en/mod/morered/docs/content/transportation/shunt)
			...
			<td>
				![Shaped Crafting Recipe for Distributors](https://commoble.net/images/morered/recipes/distributor_recipe.png)
			</td>
		</tr>
	</tbody>
</table>
...
![](https://commoble.net/images/tubesreloaded/distributor.gif)
