...
The Pliers can connect [Tubes](@morered:tube) to each other.
...
<table>
	...
	<tbody>
		<tr>
			...
			<td style={{width: '30%'}}>
				* 3x [<Asset width={32} height={32} location='iron_ingot'/> Iron Ingot](https://minecraft.wiki/Iron_Ingot)
				* 1x [<Asset width={32} height={32} location='morered:tube'/> Tube](@morered:tube)
			</td>
			<td>
				* 1x Pliers
			</td>
...
and will act as a wrenchlike item for other mods which allow it. Holding sprint while
using the pliers on logic gates or gearshifters will change the axis of rotation.
