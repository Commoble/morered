...
<table>
	...
	<tbody>
		<tr>
			...
			<td style={{width: '30%'}}>
				* 6x [<Asset width={32} height={32} location='cobblestone'/> Cobblestone](https://minecraft.wiki/Cobblestone)
				* 1x [<Asset width={32} height={32} location='piston'/> Piston](https://minecraft.wiki/Piston)
