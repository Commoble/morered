...
<table>
	...
	<tbody>
		<tr>
			...
			<td style={{width: '30%'}}>
				* 1x [<Asset width={32} height={32} location='morered:filter'/> Filter](@morered:filter)
				* 1x [<Asset width={32} height={32} location='slime_ball'/> Slimeball](https://minecraft.wiki/Slimeball)
				* 1x [<Asset width={32} height={32} location='hopper'/> Hopper](https://minecraft.wiki/Hopper)
			</td>
			<td>
				* 1x Osmosis Filter
			</td>
