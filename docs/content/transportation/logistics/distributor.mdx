...
<table>
	...
	<tbody>
		<tr>
			...
			<td style={{width: '30%'}}>
				* 4x [<Asset width={32} height={32} location='morered:shunt'/> Shunt](@morered:shunt)
				* 4x [<Asset width={32} height={32} location='cobblestone'/> Cobblestone](https://minecraft.wiki/Cobblestone)
				* 1x [<Asset width={32} height={32} location='oak_fence_gate'/> Fence Gate](https://minecraft.wiki/Fence_Gate)
			</td>
			<td>
				* 1x Distributor
			</td>
