...
<table>
	...
	<tbody>
		<tr>
			...
			<td>
				![Shaped Crafting Recipe for Tubes (From Copper Ingots)](https://commoble.net/images/morered/recipes/tube_recipe_from_copper.png)
			</td>
		</tr>
		<tr>
			<td>Shaped Crafting</td>
			...
			<td>
				![Shaped Crafting Recipe for Tubes (From Gold Ingots)](https://commoble.net/images/morered/recipes/tube_recipe_from_gold.png)
			</td>
		</tr>
	</tbody>
</table>
...
![Tube blocks connecting a hopper to a chest](https://commoble.net/images/tubesreloaded/tube.png)
...
![](https://commoble.net/images/tubesreloaded/waterTubes.gif)
