...
Redwire Spools are items used to connect [Redwire Junctions](@morered:redwire_junction),
...
<table>
	...
	<tbody>
		<tr>
			...
			<td style={{width: '30%'}}>
				* 4x [<Asset width={32} height={32} location='iron_ingot'/> Iron Ingot](https://minecraft.wiki/Iron_Ingot)
				* 3x [<Asset width={32} height={32} location='morered:red_alloy_wire'/> Red Alloy Wire](@morered:red_alloy_wire)
				* 4x [<Asset width={32} height={32} location='stick'/> Stick](https://minecraft.wiki/Stick)
			</td>
			<td>
				* 1x Redwire Spool
			</td>
