	...
	<tbody>
		<tr>
			...
			<td style={{width: '30%'}}>
				...
				* 3x [<ModAsset width={32} height={32} location='morered:item/bundled_cable'/> Bundled Cable](/en/mod_morered/docs/blocks/wires_and_cables/bundled_cable)
		...
		<tr>
			...
			<td style={{width: '30%'}}>
				...
				* 1x [<ModAsset width={32} height={32} location='iron_ingot'/> Iron Ingot](https://minecraft.wiki/Iron_Ingot)
				* 1x [<ModAsset width={32} height={32} location='morered:item/bundled_cable'/> Bundled Cable](/en/mod_morered/docs/blocks/wires_and_cables/bundled_cable)
			</td>
			<td>
				* 1x Cable Junction
			</td>
