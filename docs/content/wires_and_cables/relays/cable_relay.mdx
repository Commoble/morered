...
Cable Relays can be connected to other Cable Relays or to [Cable Junctions](/en/mod_morered/docs/blocks/wires_and_cables/cable_junction) by using a [Bundled Cable Spool](@morered:bundled_cable_spool) on two such blocks. Connections can be removed by using the spool on the two connected blocks again.
