...
<table>
	...
	<tbody>
		<tr>
			...
			<td>
				![Shaped Crafting Recipe for Stone Plates](https://commoble.net/images/morered/recipes/stone_plate_recipe.png)
			</td>
		</tr>
		<tr>
			<td>Stonecutting</td>
			...
			<td>
				![Stone Plates from Stonecutting Smooth Stone](https://commoble.net/images/morered/recipes/stone_plates_from_stonecutting_smooth_stone.png)
			</td>
		</tr>
		<tr>
			<td>Stonecutting</td>
			...
			<td>
				![Stone Plates from Stonecutting Smooth Stone Slab](https://commoble.net/images/morered/recipes/stone_plates_from_stonecutting_smooth_stone_slab.png)
			</td>
		</tr>
	</tbody>
</table>
...
![Stone Plates placed in several orientations](https://commoble.net/images/morered/stone_plates.png)
