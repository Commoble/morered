...
<table>
	...
	<tbody>
		<tr>
			...
			<td style={{width: '30%'}}>
				* 3x [<Asset width={32} height={32} location='smooth_stone_slab'/> Smooth Stone Slab](https://minecraft.wiki/Smooth_Stone_Slab)
			</td>
			<td>
				* 12x Stone Plate
			</td>
		...
		<tr>
			<td>Stonecutting</td>
			<td style={{width: '30%'}}>
				* 1x [<Asset width={32} height={32} location='smooth_stone'/> Smooth Stone](https://minecraft.wiki/Smooth_Stone)
			</td>
			<td>
				* 8x Stone Plate
			</td>
		...
		<tr>
			<td>Stonecutting</td>
			<td style={{width: '30%'}}>
				* 1x [<Asset width={32} height={32} location='smooth_stone_slab'/> Smooth Stone Slab](https://minecraft.wiki/Smooth_Stone_Slab)
			</td>
			<td>
				* 4x Stone Plate
			</td>
