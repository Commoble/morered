...
<table>
	...
	<tbody>
		<tr>
			...
			<td style={{width: '30%'}}>
				* 8x [<Asset width={32} height={32} location='stick'/> Stick](@stick)
				* 1x [<Asset width={32} height={32} location='stripped_oak_log'/> Stripped Log](@stripped_log)
			</td>
			<td>
...
<table>
	...
	<tbody>
		<tr><td><Asset width={32} height={32} location='morered:acacia_gear'/> Acacia Gear</td><td>`morered:acacia_gear`</td><td>`block.morered.acacia_gear`</td></tr>
		<tr><td><Asset width={32} height={32} location='morered:birch_gear'/> Birch Gear</td><td>`morered:birch_gear`</td><td>`block.morered.birch_gear`</td></tr>
		<tr><td><Asset width={32} height={32} location='morered:cherry_gear'/> Cherry Gear</td><td>`morered:cherry_gear`</td><td>`block.morered.cherry_gear`</td></tr>
		<tr><td><Asset width={32} height={32} location='morered:crimson_gear'/> Crimson Gear</td><td>`morered:crimson_gear`</td><td>`block.morered.crimson_gear`</td></tr>
		<tr><td><Asset width={32} height={32} location='morered:dark_oak_gear'/> Dark Oak Gear</td><td>`morered:dark_oak_gear`</td><td>`block.morered.dark_oak_gear`</td></tr>
		<tr><td><Asset width={32} height={32} location='morered:jungle_gear'/> Jungle Gear</td><td>`morered:jungle_gear`</td><td>`block.morered.jungle_gear`</td></tr>
		<tr><td><Asset width={32} height={32} location='morered:mangrove_gear'/> Mangrove Gear</td><td>`morered:mangrove_gear`</td><td>`block.morered.mangrove_gear`</td></tr>
		<tr><td><Asset width={32} height={32} location='morered:oak_gear'/> Oak Gear</td><td>`morered:oak_gear`</td><td>`block.morered.oak_gear`</td></tr>
		<tr><td><Asset width={32} height={32} location='morered:pale_oak_gear'/> Pale Oak Gear</td><td>`morered:pale_oak_gear`</td><td>`block.morered.pale_oak_gear`</td></tr>
		<tr><td><Asset width={32} height={32} location='morered:spruce_gear'/> Spruce Gear</td><td>`morered:spruce_gear`</td><td>`block.morered.spruce_gear`</td></tr>
		<tr><td><Asset width={32} height={32} location='morered:warped_gear'/> Warped Gear</td><td>`morered:warped_gear`</td><td>`block.morered.warped_gear`</td></tr>
	</tbody>
</table>
