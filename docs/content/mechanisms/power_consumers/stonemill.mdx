...
<table>
	...
	<tbody>
		<tr>
			...
			<td>
				* 2x [<Asset width={32} height={32} location='iron_ingot'/> Iron Ingot](@iron_ingot)
				* 2x [<Asset width={32} height={32} location='iron_bars'/> Iron Bars](@iron_bars)
				* 2x [<Asset width={32} height={32} location='obsidian'/> Obsidian](@obsidan)
				* 1x [<Asset width={32} height={32} location='morered:oak_axle'/> Axle](@morered:oak_axle)
				* 1x [<Asset width={32} height={32} location='diamond_pickaxe'/> Diamond Pickaxe](@diamond_pickaxe)
