...
<table>
	...
	<tbody>
		<tr>
			...
			<td style={{width: '30%'}}>
				* 4x [<Asset width={32} height={32} location='white_wool'/> Wool](@wool)
				* 4x [<Asset width={32} height={32} location='stick'/> Stick](@stick)
				* 1x [<Asset width={32} height={32} location='morered:oak_axle'/> Axle](@morered:oak_axle)
			</td>
			<td>
		...
		<tr>
			<td>Shaped Crafting</td>
			<td style={{width: '30%'}}>
				* 4x [<Asset width={32} height={32} location='lime_wool'/> Dyed Wool](@wool)
				* 4x [<Asset width={32} height={32} location='stick'/> Stick](@stick)
				* 1x [<Asset width={32} height={32} location='morered:oak_axle'/> Axle](@morered:oak_axle)
			</td>
			<td>
		...
		<tr>
			<td>Shaped Crafting</td>
			<td style={{width: '30%'}}>
				* 4x [<Asset width={32} height={32} location='cyan_dye'/> Dye](@dye)
				* 1x [<Asset width={32} height={32} location='morered:oak_windcatcher'/> Windcatcher](@morered:oak_windcatcher)
			</td>
			<td>
...
Mechanical blocks such as [Axles](@morered:axles) and [Gears](@morered:gears)
...
<table>
	...
	<tbody>
		<tr><td><Asset width={32} height={32} location='morered:acacia_windcatcher'/> Acacia Windcatcher</td><td>`morered:acacia_windcatcher`</td><td>`block.morered.acacia_windcatcher`</td></tr>
		<tr><td><Asset width={32} height={32} location='morered:birch_windcatcher'/> Birch Windcatcher</td><td>`morered:birch_windcatcher`</td><td>`block.morered.birch_windcatcher`</td></tr>
		<tr><td><Asset width={32} height={32} location='morered:cherry_windcatcher'/> Cherry Windcatcher</td><td>`morered:cherry_windcatcher`</td><td>`block.morered.cherry_windcatcher`</td></tr>
		<tr><td><Asset width={32} height={32} location='morered:crimson_windcatcher'/> Crimson Windcatcher</td><td>`morered:crimson_windcatcher`</td><td>`block.morered.crimson_windcatcher`</td></tr>
		<tr><td><Asset width={32} height={32} location='morered:dark_oak_windcatcher'/> Dark Oak Windcatcher</td><td>`morered:dark_oak_windcatcher`</td><td>`block.morered.dark_oak_windcatcher`</td></tr>
		<tr><td><Asset width={32} height={32} location='morered:jungle_windcatcher'/> Jungle Windcatcher</td><td>`morered:jungle_windcatcher`</td><td>`block.morered.jungle_windcatcher`</td></tr>
		<tr><td><Asset width={32} height={32} location='morered:mangrove_windcatcher'/> Mangrove Windcatcher</td><td>`morered:mangrove_windcatcher`</td><td>`block.morered.mangrove_windcatcher`</td></tr>
		<tr><td><Asset width={32} height={32} location='morered:oak_windcatcher'/> Oak Windcatcher</td><td>`morered:oak_windcatcher`</td><td>`block.morered.oak_windcatcher`</td></tr>
		<tr><td><Asset width={32} height={32} location='morered:pale_oak_windcatcher'/> Pale Oak Windcatcher</td><td>`morered:pale_oak_windcatcher`</td><td>`block.morered.pale_oak_windcatcher`</td></tr>
		<tr><td><Asset width={32} height={32} location='morered:spruce_windcatcher'/> Spruce Windcatcher</td><td>`morered:spruce_windcatcher`</td><td>`block.morered.spruce_windcatcher`</td></tr>
		<tr><td><Asset width={32} height={32} location='morered:warped_windcatcher'/> Warped Windcatcher</td><td>`morered:warped_windcatcher`</td><td>`block.morered.warped_windcatcher`</td></tr>
	</tbody>
</table>
