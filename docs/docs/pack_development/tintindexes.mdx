...
Logic plate blocks such as the [AND Gate](@morered:and_gate)
...
## Red Alloy Wire
[Red Alloy Wires](@morered:red_alloy_wire)
...
the [Rotate Tints model loader]($pack_development/model_loaders) is used to denote which segment of the wire
...
* [Redwire Junction](@morered:redwire_junction)
* [Redwire Post](@morered:redwire_post)
* [Redwire Relay](@morered:redwire_relay)
